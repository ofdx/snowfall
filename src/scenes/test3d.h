...
public:
	TestScene3D(Scene::Controller *ctrl) : Scene3D(ctrl) {
		...
		// 1x1 Mesh Test
		{
			...
			Scene3D::Mesh *obj = new Scene3D::Mesh(cam, coords, faces);
			obj->translate((coord){ -5, 0, 10.5 });
			obj->set_color_fill(0xed, 0xc2, 0x13, 0xff);
